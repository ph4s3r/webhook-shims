...
#this is my mscitest integration key - global event rules named vrops shim stager
APIKEY = 'R025OA0WITZU85SAVXKYY8GQ4155H4GP'
#endpoint
...
def test_pgaerduty_allparams(post, data, expected):
    loginsightwebhookdemo.pagerduty.PAGERDUTYURL = 'https://events.pagerduty.com/v2/enqueue'
